                ...
                <div class="step-content">
                    ...
                    <div v-if="business == 1">
                        ...
                        <div class="content-form">
                            ...
                            <el-form-item label="可容纳桌数：" prop="capacity" style="width:400px;">{{ruleForm.capacity}}</el-form-item>
                        </div>
                        <div class="content-form">
                            ...
                            <div class="good-table">
                                ...
                                <div class="good-row">
                                    ...
                                    <div class="good-column">
                                        <el-form-item v-for="item in dataList0.team" :key="item.name" :label="item.name">：{{item.value}}</el-form-item>
                                    </div>
                                </div>
                                <div class="good-row">
                ...
                case 2 : case '2': case 3 : case '3':
                    for (let key in content){
                        if (content[key].category == '团队'){
                            ...
                            if (content[key].name == '摄影时长'){
                                content[key].value = content[key].value + '分钟'
                            }
                            ths.dataList2.shot.push(content[key]);
                        } else if (content[key].category == '成品'){
                            if (content[key].name == '拍摄张数' || content[key].name == '精修张数'){
                                content[key].value = content[key].value + '张'
                            }
                            if (content[key].name == '全程录像' || content[key].name == 'MV时长'){
                                content[key].value = content[key].value + '分钟'
                            }
                ...
                case 6 : case '6':
                    for (let key in content){
                        if (content[key].category == '团队'){
                            ...
                            if (content[key].name == '新娘服装' || content[key].name == '新郎服装'){
                                content[key].value = content[key].value + '套'
                            }
                            ths.dataList6.model.push(content[key]);
                        } else if (content[key].category == '成品'){
                            if (content[key].name == '相册数量'){
                                content[key].value = content[key].value + '本'
                            }
                            if (content[key].name == '相框数量'){
                                content[key].value = content[key].value + '个'
                            }
                            ths.dataList6.works.push(content[key]);
                        } else if (content[key].category == '场景'){
                            if (content[key].name == '内景数量' || content[key].name == '外景数量'){
                                content[key].value = content[key].value + '个'
                            }
                            ths.dataList6.scene.push(content[key]);
                        } else if (content[key].category == '拍摄'){
                            if (content[key].name == '拍摄张数' || content[key].name == '精修张数' || content[key].name == '入册张数'){
                                content[key].value = content[key].value + '张'
                            }
                            if (content[key].name == '拍摄天数'){
                                content[key].value = content[key].value + '天'
                            }
