            ...
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                <div class="step-content">
                    ...
                    <div class="content-form">
                        ...
                        <div class="content-form-base">
                            <el-form-item label="套餐金额" prop="price" style="width:400px;">
                    ...
                    <div class="content-form">
                        <div class="good-table">
                            <div class="good-row">
                                ...
                                <div class="good-column-right">操作</div>
                            </div>
                             <div class="good-row">
                                <div class="good-column-left">{{newTitle}}</div>
                                <div class="good-column">
                                    ...
                                    ref="saveTagInput" size="small" @keyup.enter.native="handleInputConfirm" @blur="handleInputConfirm"></el-input>
                                    <el-button v-else class="button-new-tag" size="small" @click="showInput">添加菜品</el-button>
                                </div>
                                <div class="good-column-right">
                                    <div v-if="isEdit" @click="addGroup('isEdit')">确认修改</div>
                                    <div v-else @click="addGroup('isNew')">添加菜单</div>
                                </div>
                            </div>
                            <div class="good-row" v-for="(item,index) in ruleForm.contents" :key="index" >
                                ...
                                <div class="good-column-right">
                                    <div @click="editGroup(index)">修改</div>
                                    <div @click="deleteGroup(index)">删除</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="btn-Box">
                    <el-button @click="openConfirm('ruleForm')">完成，提交菜单</el-button>
                </div>
            </el-form>
        </div>
    </div>
    ...
    methods:{
        ...
        deleteGroup(index){
            ...
            this.$confirm('是否删除该套餐?', '提示', {
                ...
                for (let i = 0;i < ths.ruleForm.contents.length;i++){
                    
                    let str = string.substring(i,i + 1);

                    ths.ruleForm.contents[i].cn = str;
                }
                let len1 = ths.ruleForm.contents.length;
