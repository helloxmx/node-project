        ...
        <div class="system-one">
            <div class="system-one-single">
                ...
                <div class="one-single-text">
                    <div class="text-title">今日接单总数</div>
                    <div class="value-box">¥<span class="text-value">{{dataObj.todayReceiveOrderNum}}</span></div>
                </div>
            </div>
            <div class="system-one-single">
                ...
                <div class="one-single-text">
                    ...
                    <div class="value-box">¥<span class="text-value">{{dataObj.todaySaleFee}}</span></div>
                </div>
            </div>
            <div class="system-one-single">
                ...
                <div class="one-single-text">
                    ...
                    <div class="value-box">¥<span class="text-value">{{dataObj.yesterdaySaleFee}}</span></div>
                </div>
            </div>
            <div class="system-one-single">
                ...
                <div class="one-single-text">
                    ...
                    <div class="value-box">¥<span class="text-value">{{dataObj.weekOrderFee}}</span></div>
                </div>
            </div>
        </div>
        <!-- 第二部分 -->
        <div class="system-two">
            ...
            <div class="two-content">
                <div class="two-item">
                    ...
                    <div class="two-text">{{dataObj.waiForReceive}}</div>
                </div>
                <div class="two-item">
                    <div class="two-title">服务中订单</div>
                    <div class="two-text">{{dataObj.inService}}</div>
                </div>
                <div class="two-item">
                    <div class="two-title">已完成订单</div>
                    <div class="two-text">{{dataObj.overService}}</div>
                </div>
            </div>
        </div>
        <!-- 第三部分 -->
        <div class="system-three">
            <div class="three-one">
                ...
                <div class="left-content">
                    <div class="two-item">
                        <div class="two-text"><img src="@/assets/img/icon/menu1.png" alt=""></div>
                        <div class="two-title">添加商品</div>
                    </div>
                    <div class="two-item">
                        <div class="two-text"><img src="@/assets/img/icon/menu2.png" alt=""></div>
                        <div class="two-title">订单列表</div>
                    </div>
                    <div class="two-item">
                        <div class="two-text"><img src="@/assets/img/icon/menu5.png" alt=""></div>
                        <div class="two-title">案例管理</div>
                    </div>
                    <div class="two-item">
                        <div class="two-text"><img src="@/assets/img/icon/menu4.png" alt=""></div>
                        <div class="two-title">交易统计</div>
                    </div>
                </div>
            </div>
            <div class="three-one">
                ...
                <div class="right-content">
                    <div class="two-item">
                        <div class="two-text">{{dataObj.OffSheet}}</div>
                        <div class="two-title">已下架</div>
                    </div>
                    <div class="two-item">
                        <div class="two-text">{{dataObj.OnSheet}}</div>
                        <div class="two-title">已上架</div>
                    </div>
                    <div class="two-item">
                        <div class="two-text">{{dataObj.allCommodities}}</div>
                        <div class="two-title">全部商品</div>
                    </div>
                </div>
            </div>
        </div>
