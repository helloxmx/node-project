            ...
            <div class="single-content">
                <div class="article-content p22 backgroundfff mr22">
                    <div class="article-title">
                        <div class="title">新人说内容</div>
                        <div class="second mt22">
                            <div class="second-item-one">新人说分类：{{article.category}}</div>
                    ...
                    <div class="content mt22">
                        ...
                        <div class="content-footer">
                            <span>点赞：{{article.priseCnt}}</span>
                            <span>收藏：{{article.commentCnt}}</span>
                        </div>
                    </div>
                    <div class="comment">
...
export default {
    ...
    computed:{
        ...mapGetters(['headerChildTitle','tk'])
    },
    mounted(){
        let ths = this;
    ...
    methods:{
        ...
        getNewSayDetail(){
            ...
            api.getNewSayDetail(params).then(res => {
                ths.article = res.data;
            }).catch(e => {
                // alert(e.msg)
            })
        },
