            ...
            <div class="list-table backgroundfff">
                ...
                <el-table
                    ...
                    <el-table-column label="推荐" width="120">
                        <template slot-scope="scope">
                            <el-switch v-model="scope.row.recommend" @change="recommendSwitch(scope.row)" active-color="#FF739E" inactive-color="#d8d8d8"></el-switch>
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        recommendSwitch(key){
            ...
            ids.push(key.id)//设置为推荐
            let recommend = 'n';

            if (key.recommend === true) {
                recommend = 'n';
            } else {
                recommend = 'y';
            }
            let params = {
                tk:ths.tk,
                ids:ids,
                itype:0,//0:推荐 1:隐藏 2:删除
                value:recommend//n 不推荐  y 推荐
            };
