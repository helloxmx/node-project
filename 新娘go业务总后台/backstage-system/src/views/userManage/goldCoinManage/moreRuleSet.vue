            ...
            <div class="p22">
                <div class="detail backgroundfff p22">
                    ...
                    <div>
                        <div class="single-item">
                            <div class="item-right">每连续签到：
                                <el-input style="width:200px" placeholder="请输入内容" v-model="input10" clearable></el-input>
                                <span>天</span>
                            </div>
                        </div>
                        <div class="single-item">
                            <div class="item-right">额外奖励：
                                <el-input style="width:200px" placeholder="请输入内容" v-model="input10" clearable></el-input>
                                <span>个</span>
                            </div>
                        </div>
                        <div class="single-item">
                            <div class="item-right">购物消费：
                                <el-input style="width:200px" placeholder="请输入内容" v-model="input10" clearable></el-input>
                                <span>个</span>
                                <span>奖励1个金币</span>
                            </div>
                        ...
                        <div class="single-item">
                            <div class="item-right">订单实际支付金额低于：
                                <el-input style="width:200px" placeholder="请输入内容" v-model="input10" clearable></el-input>
                                <span>元</span>
                                <span>不送金币</span>
                            </div>
                        ...
                        <div class="single-item">
                            <div class="item-right">单件商品最高可获得：
                                <el-input style="width:200px" placeholder="请输入内容" v-model="input10" clearable></el-input>
                                <span>个</span>
                                <span>金币</span>
                            </div>
                ...
                <div class="detail backgroundfff p22">
                    ...
                    <div>
                        ...
                        <div class="single-item">
                            <div class="item-right">最高可抵扣订单金额比例：
                                <el-input style="width:200px" placeholder="请输入内容" v-model="input10" clearable></el-input>
                                <span>%</span>
                            </div>
                        </div>
                ...
                <div class="submit-box">
                    <div class="task-submit" @click="userCoinReasonExt">提交</div>
                </div>
            </div>
        </div>
    </div>
...
export default {
    ...
    mounted(){
        ...
        ths.userCoinReasonExt();//获取列表数据 标题关键字/文章类型/文章当前页
    },
    methods: {
        ...mapActions([
        ...
        userCoinReasonExt(){
            ...
            api.userCoinReasonExt(params).then(res => {
