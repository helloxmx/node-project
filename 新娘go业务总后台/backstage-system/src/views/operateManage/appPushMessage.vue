    ...
    <div>
        ...
        <div class="p22">
            ...
            <div class="list-table backgroundfff">
                ...
                <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" :max-height="screenHeight">
                    <el-table-column type="selection" width="55"></el-table-column>
                    <el-table-column prop="resultId" label="编号" width="160"></el-table-column>
                    <el-table-column prop="title" label="推送标题"></el-table-column>
                    <el-table-column prop="type" label="类型" width="100"></el-table-column>
                    <el-table-column prop="pubTime" label="发布时间"></el-table-column>
                    <el-table-column prop="creator" label="发布人员" width="100"></el-table-column>
                    <el-table-column prop="receiver" label="接收对象" width="100"></el-table-column>
                    <el-table-column prop="result" label="发布结果" width="100"></el-table-column>
                    <el-table-column fixed="right" label="操作" width="150">
                        <template slot-scope="scope">
                            <el-button type="text" size="small" style=""
                            @click.native.prevent="editRow(scope.$index, tableData)">取消发布</el-button>
                            <el-button type="text" size="small" style=""
...
export default {
    ...
    mounted(){
        ...
        ths.getMessageList();//获取列表数据 标题关键字/文章类型/文章当前页
    },
    methods: {
        ...mapActions([
