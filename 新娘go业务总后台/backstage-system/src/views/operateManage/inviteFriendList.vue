        ...
        <div class="p22">
                        ...
                        <div class="my-select-item">
                            <el-form :inline="true" ref="form" :model="form" label-width="100px">
                                <el-form-item label="用户账号">
                                    <el-input v-model="form.keyWord" clearable placeholder="商户ID/账号"></el-input>
                                </el-form-item>
            ...
            <div class="list-table backgroundfff">
                ...
                <el-table
                    ...
                    <el-table-column prop="invitNum" label="邀请好友" width="100"></el-table-column>
                    <el-table-column prop="donenum" label="成功交易好友" width="120"></el-table-column>
                    <el-table-column prop="rewardsTotal" label="累计奖励"></el-table-column>
...
export default {
    ...
    mounted(){
        ...
        ths.getUserInviteByUser(ths.keyWord,null,ths.page);//获取列表数据 标题关键字/文章类型/文章当前页
    },
    methods: {
        ...mapActions([
        ...
        //获取列表数据
        getUserInviteByUser(keyWord,type,page){
            let ths = this;
            let params = {
                tk:ths.tk,
                keyWord:keyWord,
            ...
            api.getUserInviteByUser(params).then(res => {
        ...
        searchFn(){
            ...
            ths.page = 1;
            ths.getUserInviteByUser(ths.keyWord,ths.typeId,1);
        ...
        handleCurrentChange(val) {
            ...
            ths.page = val;
            ths.getUserInviteByUser(ths.keyWord,ths.typeId,val);
        },
        //推荐或者不推荐的操作按钮
