        ...
        <div class="p22">
            ...
            <div class="list-table backgroundfff">
                ...
                <el-table
                    ...
                    <el-table-column prop="type" label="发布人员" width="100"></el-table-column>
                    <el-table-column prop="type" label="接收对象" width="100"></el-table-column>
                    <el-table-column prop="type" label="发布结果" width="100"></el-table-column>
